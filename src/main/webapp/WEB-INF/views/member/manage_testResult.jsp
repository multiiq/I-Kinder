                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item"><a class="text-white" href="manage_testResult.do">검사결과</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row ">
                ...
                <div class="col-lg-10 col-xs-12 " style="padding:0 10rem;">
                    <ul class="d-flex align-items-center user-station" style="list-style: none; padding-left: 0;">
                        ...
                        <i class="fas fa-angle-right"></i>
                        <li class="mx-2"><a href="manage_testResult.do">검사결과</a></li>
                    </ul>
                    <h1 class="my-5">검사 결과</h1>
