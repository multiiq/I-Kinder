            ...
            <div class="row ">
                ...
                <div class="col-lg-10 col-xs-12 " >
                    <ul class="d-flex align-items-center user-station" style="list-style: none;">
                        ...
                        <li class="mx-2"><a href="manage_teacher.do">교사관리</a></li>
                        <i class="fas fa-angle-right"></i>
                        <li class="mx-2"><a href="new_teacherForm.do">교사등록</a></li>
                    </ul>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row text-center" style="margin-top: 3.5rem;">
                                        <div class="col-lg-6 col-sm-12 my-2">
                                            <a href="#" class="btn btn-dark w-100 py-2">등록</a>
                                        </div>
                                        <div class="col-lg-6 col-sm-12 my-2">
                                            <button type="button" class="btn btn-outline-primary  w-100 py-2" onclick="historyBack()">취소</button>
                                        </div>
                                    </div>
                                </div>   
                            </div>
