                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item"><a class="text-white" href="manage_child.do">유아관리</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-10 col-xs-12 " style="padding:0 10rem;">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-6 d-flex justify-content-end">
                            <button onclick="go_form()" class="btn btn-dark px-4 h-75">유아 등록</button>
                        </div>
                    </div>
...
<script>
    const go_form=()=>{
        location.href="new_childrenForm.do";
    }
</script>